              ...
              <div className="space-y-4 mb-8">
                {plan.features.map((feature, featureIndex) => (
                  <div key={featureIndex} className="flex items-center text-legal-text">
                    <svg className="w-5 h-5 text-legal-gold mr-3" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <tr key={index} className="border-b border-legal-accent/30">
                      ...
                      <td className="text-center py-3 px-4">
                        {typeof item.simple === 'boolean' ? (
                          item.simple ? (
                            <svg className="w-5 h-5 text-legal-gold mx-auto" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                            </svg>
                          ) : (
                            <svg className="w-5 h-5 text-legal-text/40 mx-auto" fill="currentColor" viewBox="0 0 20 20">
